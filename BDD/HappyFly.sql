...
--
-- Hôte : localhost:3306
-- Généré le : mar. 22 mars 2022 à 10:06
...
ALTER TABLE `Reservation`
  ADD PRIMARY KEY (`compteReservationID`,`CircuitID`,`dateReservation`),
...
--
ALTER TABLE `Pays`
  MODIFY `paysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
